...
let CompanyService = class CompanyService {
    addCompany(payload, context) {
        return __awaiter(this, void 0, void 0, function* () {
            const { user } = context;
            const cleanPayload = utils_1.utils.clean(payload);
            const data = yield schema_1.companySchema.validateAsync(cleanPayload);
            if (data.email) {
            ...
            return yield prisma_1.prisma.company.create({ data: Object.assign(Object.assign({}, data), { ownerId: user.id }) });
        });
    }
